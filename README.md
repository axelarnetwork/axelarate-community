...
5. Trigger signing of the transfers to Ethereum
  ...
  ```
  Look for commandID in the output
  ```
    {
    "key": "commandID",
...
You can now open Metamask, add the custom asset (Bitcoin) with contract address `0x93676f47b3bb50477def0f49351f21ad2235f7cf` and see the minted Bitcoin tokens appear in it. 
